...
namespace XPath
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.button6.Text = "Nuevo puesto";
        ...
        readonly string FILE_NAME = Properties.Resources.ResourceManager.GetString("nombre");
		private void Form1_Load(object sender, System.EventArgs e)
		{
            ...
            XmlWriter write = XmlWriter.Create(FILE_NAME,ws);
            
            //write.WriteRaw(Properties.Resources.ResourceManager.GetString("config"));
            write.WriteDocType("config", null, "config.dtd", null);
            write.WriteWhitespace(Environment.NewLine);
            write.WriteRaw(Properties.Resources.ResourceManager.GetString("config"));
            write.Close();
            TextWriter tw = new StreamWriter("config.dtd");
            tw.Write(@"<?xml version=""1.0"" encoding=""UTF-8""?>
<!ELEMENT config (voto)+>
<!ELEMENT voto (candidato)+>
<!ATTLIST voto puesto ID #REQUIRED>
<!ELEMENT candidato EMPTY>
<!ATTLIST candidato partido CDATA #REQUIRED>
<!ATTLIST candidato nombre CDATA #REQUIRED>
<!ATTLIST candidato imagen CDATA #IMPLIED>
<!ATTLIST candidato partido CDATA #IMPLIED>");
            tw.Close();
