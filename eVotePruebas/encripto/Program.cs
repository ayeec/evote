...
namespace encripto
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            cryp.Close();
            man.Clear();
            Console.WriteLine(BitConverter.ToInt32(plain, 0));
            ...
            ict = man.CreateDecryptor(llave, Encoding.ASCII.GetBytes("0FRna73m*aze01xY"));
            ...
            Console.WriteLine(BitConverter.ToInt32(des, 0));
